...
import com.rickyandrean.a2320j2802_submissionintermediate.database.RemoteKeys
...
class StoryRemoteMediator(private val database: StoryDatabase, private val apiService: ApiService) :
    ...
    override suspend fun load(
        ...
        return try {
            val responseData = apiService.storiesPaging(MainActivity.TOKEN ,page, state.config.pageSize)
